    ...
    <>
      <div className="flex h-screen bg-gray-200 font-roboto">
        <div className="flex">
          ...
          <div className={` ${isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'} fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0`}>

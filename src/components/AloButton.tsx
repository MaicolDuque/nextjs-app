...
const classByType: Record<string, string> = {
  ...
  fill: 'text-white bg-alo-primary hover:opacity-80 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800',
}
